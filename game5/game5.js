...
const allGame = [
  {
    ...
    time: 119,
    img: {
      real: "./game5/images/game2/real1.jpg",
      fake: "./game5/images/game2/fake1.png",
    },
    answer: [
      {
        p1: { x: 43.796992481203006, y: 12.406015037593985 },
        p2: { x: 50.18796992481202, y: 18.60902255639098 },
        point: 25,
      },
      {
        p1: { x: 43.045112781954884, y: 33.27067669172932 },
        p2: { x: 46.05263157894737, y: 36.09022556390977 },
        point: 45,
      },
      {
        p1: { x: 46.05263157894737, y: 61.278195488721806 },
        p2: { x: 50.37593984962406, y: 66.35338345864662 },
        point: 70,
      },
      {
        p1: { x: 72.74436090225564, y: 74.24812030075188 },
        p2: { x: 86.09022556390977, y: 88.1578947368421 },
        point: 45,
      },
    ],
  },
